...
@section('container')
    <div class="container">
        <div class="row">
            <div class="col-10">
            <h1 class="mt-3">Tambah Data Ujian</h1>
            ...
            @csrf
                <div class="form-group">
                    ...
                    id="nama_mk" 
                    placeholder="Masukkan Nama Mata Kuliah" name="nama_mk" value="{{old('nama_mk')}}">
                ...
                <div class="form-group">
                    ...
                    id="dosen" 
                    placeholder="Masukkan Nama Dosen" name="dosen" value="{{old('dosen')}}">
                ...
                <div class="form-group">
                    ...
                    id="jumlah_soal" 
                    placeholder="Masukkan Jumlah Soal" name="jumlah_soal" value="{{old('jumlah_soal')}}">
